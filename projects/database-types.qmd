...
**OLTP** stands for *Online Transaction Processing*. This is the classic relational database you learned about in 100 level IS and STAT classes — think PostgreSQL, MySQL, or SQLite.
...
- **Spin up a free tier** of [Snowflake](https://signup.snowflake.com/) or [MongoDB Atlas](https://www.mongodb.com/cloud/atlas/register) and load a small dataset using the pattern described above.
